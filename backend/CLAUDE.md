...
> **Note:** Keep this file updated as the project evolves. Update it when adding new features, changing architecture, or modifying development workflows.

## Project Overview

This is a Laravel 12 backend application built with PHP 8.2+. It is currently a fresh Laravel installation with standard scaffolding.
...
- **Database Admin**: pgAdmin 4 (via Docker)
- **Testing**: Pest PHP
- **Frontend Build**: Vite
...
# Start development servers (web, queue, vite)
composer dev
...
- Tests use Pest PHP (not PHPUnit syntax)
